            ...
            <div className="container">
              <div className={styles.dropdownContent}>
                <div className={styles.dropdownColumn}>
                  <h3>Categorii Suplimente</h3>
                  <ul>
                    <li><a href="#">Longevitate & Anti-Aging</a></li>
                    <li><a href="#">Imunitate & Energie</a></li>
                    <li><a href="#">Sănătatea Inimii</a></li>
                    <li><a href="#">Focus & Memorie</a></li>
                ...
                <div className={styles.dropdownColumn}>
                  <h3>Recomandări</h3>
                  <ul>
                    <li><a href="#">NMN Puritate 99%</a></li>
                    <li><a href="#">Resveratrol Complex</a></li>
                    <li><a href="#">Vitamina D3 + K2</a></li>
                    <li><a href="#">Pachete Promoționale</a></li>
                  </ul>
                </div>
                <div className={styles.dropdownColumn}>
                  <div className={styles.dropdownPromo}>
                    <div className={styles.promoImage}>
                      <span className={styles.promoTag}>NOU</span>
                    </div>
                    <h4>Coenzima Q10 Lipozomală</h4>
                    <p>Absorbție celulară maximizată pentru energia ta zilnică.</p>
                  </div>
                </div>
              </div>
            </div>
